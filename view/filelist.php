...
<head>
  ...
  <title>ROTU ARMY UMP|FILE LIST(CURRENT INTAKE)</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav class="navbar navbar-light fixed-top">
        <div class="divnav">
          ...
          <a class="navbarbrand">ROTU ARMY UMP OFFICIAL PORTAL (CURRENT INTAKE)</a>
          ...
          <div style="background-color: rgb(1, 65, 17); color: white;" class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <form class="d-flex" action="http://www.google.com/search" method="GET">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                  <a style="color: white;" class="nav-link active" aria-current="page" href="../view/filelist.php?loginid=<?php echo $login["loginid"]; ?>">SYLLABUS DOWNLOAD LIST</a>
                </li>
...
?>
      <div class="pictitle"></div><div class="texttitle"><h2>Syllabus Download List<br><h5>Login | Syllabus Download List</h5></div>
      <br><br><br>
      <form class="d-flex">
                      ...
                      <div>
                              <table>
                                  ...
                                  <td><?php echo $fileupload['id'];?></td>
                                    <td><a target="_blank" href="adminfileview.php?id=<?php echo $fileupload["id"]; ?>" ><?php echo $fileupload['name'];?></a></td>
                                    <td><a class="edit" href="adminfileview.php?id=<?php echo $fileupload["id"]; ?>" type="edit" value="DELETE">VIEW</a></td>
                                  </tr>
