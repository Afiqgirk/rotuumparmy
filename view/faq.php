...
<head>
  ...
  <body>
    ...
    <nav class="navbar navbar-light fixed-top">
      ...
      <?php
        ...
        ?>
      <div class="pictitle"></div><div class="texttitle"><h2>Frequently Asked Question<br><h5>Home | FAQ</h5></div>
      <br><br><br>
      <form class="d-flex">
  ...
  <div class="rowsidefaq" id="myDIV">
      ...
      ?>
        ...
        <div class="panelfaq">
          <br><br><p>A<?php echo $faq['id']?>. <?php echo $faq['answer'];?></p>
        </div>
